...
class Lumen implements Adapter
{
    ...
    public function dispatch(Request $request, $version)
    {
        ...
        $dispatch =  $this->app->dispatch($request);

        $this->recoverMiddlewareFromApp();
        return $dispatch;
    }
    ...
    protected function removeMiddlewareFromApp()
    {
        ...
        $reflection = $this->getAppReflection();
        $property = $reflection->getProperty('middleware');
        $property->setAccessible(true);
        $this->appMiddleware = $property->getValue($this->app);
        $property->setValue($this->app, []);
        $property->setAccessible(false);
    }

    protected function recoverMiddlewareFromApp()
    {
        $reflection = $this->getAppReflection();
        $property = $reflection->getProperty('middleware');
        $property->setAccessible(true);
        $property->setValue($this->app, $this->appMiddleware);
        $property->setAccessible(false);
    }
